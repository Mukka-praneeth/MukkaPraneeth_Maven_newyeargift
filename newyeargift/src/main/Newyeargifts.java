...
public class Newyeargifts
{
  public static void main (String[]args)
  {
    ...
    WeightOfChocolates = 93 * NoOfPieces;
	...
	if (ChocolatesPrice > SweetPrice)
	  System.out.println ("sorted order is Chocolates" + ChocolatesPrice +
			      " sweets " + SweetPrice);
	else
	  System.out.println ("sorted order by price is sweets" + SweetPrice +
			      "  Chocolates " + ChocolatesPrice);
      }
    if (Order == 2)
      {
	System.out.println ("toatl weight of gift:" +
			    (WeightOfChocolates + WeightOfSweet));
	if (WeightOfChocolates > WeightOfSweet)
	  System.out.println ("sorted order is Chocolates" +
			      WeightOfChocolates + " sweets " +
			      WeightOfSweet);
	else
	  System.out.println ("sorted order by price is sweets" +
			      WeightOfSweet + "  Chocolates " +
			      WeightOfChocolates);
      }
